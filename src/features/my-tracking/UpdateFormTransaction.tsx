...
const UpdateFormTransaction: React.FC<{
  updateTransaction: any;
  deleteTransaction: any;
  transaction: any;
  onCloseModal?: () => void;
}> = ({ updateTransaction, deleteTransaction, transaction, onCloseModal }) => {
  ...
  const [formData, setFormData] = useState(() => {
    return {
      ...transaction,
      date: getCurrentDate(transaction?.date),
    };
  });
  function getCurrentDate(dateString: string) {
    ...
    <div className="flex w-full items-center justify-center">
      <div className="rounded-lg">
        ...
        <form
          onSubmit={(e) => {
            e.preventDefault();
            updateTransaction(formData, onCloseModal!);
          }}
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <BsFillTrashFill
              className="mt-5 cursor-pointer text-2xl text-red-600"
...
export default UpdateFormTransaction;
